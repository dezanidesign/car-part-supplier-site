  ...
  return (
    <div className="min-h-screen bg-[var(--bg-dark)] pb-24 px-6 md:px-16 animate-in fade-in duration-700 [--section-bg:var(--bg-dark)]">
       ...
       <div className="max-w-[1920px] mx-auto mb-24 border-b border-white/10 pb-12">
          <span className="text-[var(--accent)] text-xs font-bold uppercase tracking-widest mb-4 block">Rolling Stock</span>
       ...
       <div className="grid lg:grid-cols-12 gap-8 mb-32 border-y border-white/10 py-16">
          <div className="lg:col-span-4">
             <h3 className="font-display text-3xl text-white font-bold uppercase mb-6">Precision <span className="text-[var(--accent)]">Fitting</span></h3>
             ...
             <ul className="space-y-3 text-sm text-gray-300">
                <li className="flex items-center"><Settings size={14} className="text-[var(--accent)] mr-3"/> Advanced Balancing</li>
                <li className="flex items-center"><Settings size={14} className="text-[var(--accent)] mr-3"/> Torque-Setting Protocol</li>
                <li className="flex items-center"><Settings size={14} className="text-[var(--accent)] mr-3"/> Geometry Alignment</li>
             </ul>
          </div>
       ...
       <div className="bg-[#111] p-12 md:p-20 relative overflow-hidden group">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-[var(--accent)]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
             <div className="max-w-xl">
                ...
                <Link href="/contact" className="inline-flex items-center gap-3 text-white border-b border-[var(--accent)] pb-1 hover:text-[var(--accent)] transition-colors">
