...
const InteriorsPage = () => {
  return (
    <div className="min-h-screen bg-[var(--bg-dark)] animate-in fade-in duration-700 [--section-bg:var(--bg-dark)]">
       <div className="flex flex-col lg:flex-row min-h-screen">
          
          {/* Left: Sticky Narrative Content */}
          <div className="header-sticky lg:w-1/2 lg:h-[calc(100vh-var(--header-offset))] lg:sticky bg-[var(--bg-dark)] p-6 md:p-16 flex flex-col justify-center border-r border-white/5 z-10">
             <div className="mb-12">
                <span className="text-[var(--accent)] text-xs font-bold uppercase tracking-widest mb-4 block">The Atelier</span>
             ...
             <div className="space-y-12">
                <div>
                   <h3 className="font-display text-2xl text-white font-bold uppercase mb-4 flex items-center"><Armchair size={20} className="mr-3 text-[var(--accent)]"/> Quality Tailoring</h3>
                ...
                <div>
                   <h3 className="font-display text-2xl text-white font-bold uppercase mb-4 flex items-center"><Maximize size={20} className="mr-3 text-[var(--accent)]"/> Total Customisation</h3>
                   <p className="text-gray-500 text-sm leading-relaxed">
